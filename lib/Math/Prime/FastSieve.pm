...
You can find documentation for this module with the perldoc command.
    ...
    perldoc Alt::Math::Prime::FastSieve
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=Alt-Math-Prime-FastSieve>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/Alt-Math-Prime-FastSieve>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/Alt-Math-Prime-FastSieve>

=item * Search CPAN

L<http://search.cpan.org/dist/Alt-Math-Prime-FastSieve/>
...
fit, but generally speaking, Dana's module is faster, more complete, and 
supercedes this module in its functionality and capabilities.
